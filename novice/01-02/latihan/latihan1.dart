...
main() {
  ...
  // tenary
  print(result < 2000
      ? 'the result is lowe than 2000'
      : 'the result is higher than 2000');
  ...
  // assert
  assert(evenNo % 2 == 0, 'you entered odd number, it should be an even number');
  ...
  if (isTrue && isFalse)
    ...
    print('The result is either false or true');
  else
...
class Avanza extends Car with Breaker {
  ...
  void describe() {
    print(
        'The avanza with color of $_color has $_tires tires, $_doors doors, $_maxSpeed max speed\nand its oil is $_oil');
  }
